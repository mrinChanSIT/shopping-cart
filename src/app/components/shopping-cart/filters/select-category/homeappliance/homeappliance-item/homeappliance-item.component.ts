...
@Component({
  selector: 'app-homeappliance-item',
  templateUrl: './homeappliance-item.component.html',
  styleUrls: ['./homeappliance-item.component.css']
})
export class HomeapplianceItemComponent implements OnInit {
